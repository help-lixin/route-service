...
@Configuration
@ImportAutoConfiguration({CommonRouteConfig.class, EurekaClientConfig.class, NacosClientConfig.class, FeignRouteConfig.class, WebRouteConfig.class, GatewayRouteConfig.class})
