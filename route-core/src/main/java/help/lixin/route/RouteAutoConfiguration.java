...
@Configuration
@ImportAutoConfiguration({EurekaRewriteServerConfig.class, NacosRewriteServerConfig.class, CommonRouteConfig.class, FeignRouteConfig.class, WebRouteConfig.class, GatewayRouteConfig.class})
